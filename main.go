...
func main() {
	...
	router.HandleFunc("POST /api/auth/verify-password-otp", middleware.Logger(authRoutes.VerifyPasswordChangeRequestAPI))
	router.HandleFunc("POST /api/auth/reset-password", middleware.Logger(authRoutes.ResetPasswordAPI))
